            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="{{url('/register_user')}}" method="post" class="form-horizontal">
                        ...
                        <input type="tel" placeholder="Phone Number" pattern="[0-9]*" name="mobile" value="{{old('mobile')}}"/>
                        ...
                        <input type="text" placeholder="Postal Code" name="pincode" value="{{old('pincode')}}" >
