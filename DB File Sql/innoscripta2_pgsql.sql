...
CREATE TABLE IF NOT EXISTS cart (
  id int CHECK (id > 0) NOT NULL DEFAULT NEXTVAL ('cart_seq'),
...
ALTER SEQUENCE cart_seq RESTART WITH 45;
...
CREATE TABLE IF NOT EXISTS categories (
  ...
  updated_at timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (id),
  CONSTRAINT slug UNIQUE  (name)
)   ;

ALTER SEQUENCE categories_seq RESTART WITH 25;
...
CREATE TABLE IF NOT EXISTS countries (
  id int CHECK (id > 0) NOT NULL DEFAULT NEXTVAL ('countries_seq'),
...
ALTER SEQUENCE countries_seq RESTART WITH 298;
...
CREATE TABLE IF NOT EXISTS delivery_address (
  id int CHECK (id > 0) NOT NULL DEFAULT NEXTVAL ('delivery_address_seq'),
...
ALTER SEQUENCE delivery_address_seq RESTART WITH 4;
...
ALTER SEQUENCE migrations_seq RESTART WITH 20;
...
ALTER SEQUENCE orders_seq RESTART WITH 8;
...
ALTER SEQUENCE products_seq RESTART WITH 36;
...
CREATE SEQUENCE product_att_seq;

CREATE TABLE IF NOT EXISTS product_att (
  id int CHECK (id > 0) NOT NULL DEFAULT NEXTVAL ('product_att_seq'),
  products_id int NOT NULL,
  code varchar(191) NOT NULL,
  size varchar(191) NOT NULL,
  price double precision NOT NULL,
...
ALTER SEQUENCE product_att_seq RESTART WITH 35;
...
CREATE SEQUENCE tblgallery_seq;

CREATE TABLE IF NOT EXISTS tblgallery (
  id int CHECK (id > 0) NOT NULL DEFAULT NEXTVAL ('tblgallery_seq'),
  products_id int NOT NULL,
  image varchar(191) NOT NULL,
  created_at timestamp(0) NULL DEFAULT NULL,
  updated_at timestamp(0) NULL DEFAULT NULL,
...
ALTER SEQUENCE tblgallery_seq RESTART WITH 35;
